function bindAddr(path){
	var pro=document.getElementById("select_address_province");
	var city=document.getElementById("select_address_city");
	var area=document.getElementById("select_address_area");
